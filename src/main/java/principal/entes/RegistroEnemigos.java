    ...
    public static Enemigo obtenerEnemigo(final int idEnemigo) {
        ...
        switch (idEnemigo) {
            case 1:
                ...
                enemigo = new Enemigo(idEnemigo, "DEMON", 60, "sonidos/Zombie.wav", 30, hs, 400,new ContenedorObjetos(),0);
                
                break;
            case 2:
                hs = new HojaSprites(Constantes.RUTA_SKELETON_SWORD, Constantes.LADO_SPRITE, false);
                enemigo = new Enemigo(idEnemigo, "SKELETON", 60, "sonidos/Zombie.wav", 30, hs,400, new ContenedorObjetos(),0);
